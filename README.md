...
in Germany looks like. Then, one is lead to scroll down by an animated arrow that points downwards, to explore more about Germany and the German
language. As, one scrolls down to see more sections of the homepage, one can gather knowledge of the German culture, meals, and popular places in Germany
...
* Bootstrap
    * [BootstrapCDN Link](https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css)
        * This was used for the styling of the webpage, using mostly its grid system, navigation bar and carousel attributes
...
* Have the linked websites be opened up, on new tabs
...
* The videos were obtained from the following YouTube channels: 
